...
var dnanasum = tryRequire( resolve( __dirname, './../lib/dnanasum.native.js' ) );
var opts = {
...
tape( 'the function has an arity of 3', opts, function test( t ) {
	t.strictEqual( dnanasum.length, 3, 'has expected arity' );
	t.end();
});
...
tape( 'the functions throws an error if provided a first argument which is not a number', opts, function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			dnanasum( value, new Float64Array( 10 ), 1 );
		};
	}
});
...
tape( 'the functions throws an error if provided a third argument which is not a number', opts, function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			dnanasum( 10, new Float64Array( 10 ), value );
		};
	}
});
...
tape( 'the function calculates the sum of absolute values (ignoring NaN values)', opts, function test( t ) {
	...
	x = new Float64Array( [ 1.0, -2.0, -4.0, 5.0, 0.0, NaN, 3.0, 0.0, -3.0, 3.0 ] ); // eslint-disable-line max-len
